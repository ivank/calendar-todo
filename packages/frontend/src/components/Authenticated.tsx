      ...
      <div className="mx-auto max-w-2xl py-28 sm:py-36 lg:py-48">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-900 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <a href="https://github.com/ivank/calendar-todo" className="font-semibold text-gray-900">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Stay on top of your work</h1>
