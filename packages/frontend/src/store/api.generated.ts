...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    getWellKnownHealthCheck: build.query<
      GetWellKnownHealthCheckApiResponse,
      GetWellKnownHealthCheckApiArg
    >({
      query: () => ({ url: `/.well-known/health-check` }),
    }),
    getWellKnownOpenapiJson: build.query<
      GetWellKnownOpenapiJsonApiResponse,
      GetWellKnownOpenapiJsonApiArg
    >({
    ...
    postAuthAuthentication: build.mutation<
      PostAuthAuthenticationApiResponse,
      PostAuthAuthenticationApiArg
    >({
      query: (queryArg) => ({
    ...
    >({
      query: (queryArg) => ({
        url: `/auth/authentication/verification`,
        method: "POST",
        body: queryArg.body,
      }),
    }),
    ...
    patchListsById: build.mutation<
      PatchListsByIdApiResponse,
      PatchListsByIdApiArg
    >({
      query: (queryArg) => ({
    ...
    deleteListsById: build.mutation<
      DeleteListsByIdApiResponse,
      DeleteListsByIdApiArg
    >({
...
export type GetWellKnownHealthCheckApiResponse =
...
export type PostAuthAuthenticationApiResponse =
  /** status 200 Default Response */ {
    id: number;
    response: {
      challenge: string;
